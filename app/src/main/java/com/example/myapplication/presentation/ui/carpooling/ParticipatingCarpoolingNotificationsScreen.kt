// ParticipatingCarpoolingNotificationsScreen.kt
...
@Composable
fun ParticipatingCarpoolingNotificationsScreen(
    ...
    Column(
        ...
        ScreenHeader(
            title = "Carpooling Notifications",
            onLogoutClick = {
                auth.signOut()
                onLogout()
            }
            ...
            Card(
                ...
                Column(Modifier.padding(8.dp)) {
                    ...
                    Button(onClick = {
                        ...
                        navController.navigate("viewCarpoolingNotificationDetails/$notificationId")
                    }) {
                        Text("View Message")
                    }
                }
