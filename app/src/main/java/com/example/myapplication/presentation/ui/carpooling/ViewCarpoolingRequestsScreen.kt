// ViewCarpoolingRequestsScreen.kt
...
@Composable
fun ViewCarpoolingRequestsScreen(
    ...
    Column(
        ...
        ScreenHeader(
            title = "View Carpooling Participation Requests",
            onLogoutClick = {
                auth.signOut()
                onLogout()
            }
        ...
        Text("Carpooling Participation Requests", style = MaterialTheme.typography.titleMedium)
            ...
            Card(
                ...
                Column(Modifier.padding(8.dp)) {
                    ...
                    Button(onClick = {
                        ...
                        navController.navigate("viewCarpoolingRequestDetails/$requestId")
                    }) {
                        Text("View")
                    }
                }
